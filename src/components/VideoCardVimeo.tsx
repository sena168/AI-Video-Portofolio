...
const VideoCardVimeo = ({ video }: VideoCardVimeoProps) => {
  ...
  // We can reload the iframe or something, but for simplicity, just set currently playing
  useEffect(() => {
    if (currentlyPlaying && currentlyPlaying !== video.id) {
      // For Vimeo, we can't pause directly, but we can track
    }
